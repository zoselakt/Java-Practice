...
public class H_Method_01 {
	public static void main(String[] args) {
		...
		// 메서드 종류
		// 반환값 X / 인자값 X : void를 사용하고 특별한 값이 만들어지는 것이 아니라 println하여 바로 출력
		// 반환값 X / 인자값 O : void를 사용하여 void 메서드 내에서 출력
		// 반환값 O / 인자값 X : 자료형을 static과 함께 적어 return하여 출력
		// 반환값 O / 인자값 O : 반환값이 있으므로 void는 사용하지 않고 인자값이 있으므로 파라미터에 값을 넣는다(자료형 + 임의의 변수)
